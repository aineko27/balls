...
var stage01 = function(ball, wall){
	...
	//wall[04].set( 715, 432,  65,  65, 0, 0, 2, 0);
	//wall[05].set( 450, 230,  65,  65, 0, 0, 3, 0);
	...
	//wall[10].set( 750, 160,  30,  15, 0, 0, 1, 0);
	wall[11].set( 755, 240,  20,  10, 0, 0, 2, 0);
	//wall[12].set( 755, 240,  20,  10, 0, 0, 2, 0);
	//wall[13].set( 755, 240,  20,  10, 0, 0, 2, 0);
	/*wall[3].set(  40, 463, 100,  10, -Math.PI / 15, 0, 1, 0);
	wall[4].set( 100, 228,  80,  80, Math.PI / 8,  0, 2, 0);
	wall[5].set( 280, 330, 450,  75, 0,     0, 2, 0);
	wall[7].set(  30, 330, 220,  75, 0,     0, 2, 0);*/
	//wall[8].set( 470, 330,  60,  100,  0., 0, 1, 0);
	//awall[6].set( 360,  40,  30, 250, 0.1,          0, 3, 0);
	/*wall[3].set(   0, 130,  74,  75, 0,  0,  2, 0);
	wall[5].set( 272, 130, 170,  75, 0.0,            0, 3, 0);
	wall[4].set(  74, 130, 170,  75, 0.0,            0, 3, 0);
	wall[6].set( 442, 130,  30,  367,  0,  0,  3, 0);*/
	//wall[8].set( 470, 449,  50,  50, -0.75, 0, 1, 0);
	nowStage = 1;
};
